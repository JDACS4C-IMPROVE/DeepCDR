...
import preprocess_with_data_loader
import train_with_data_loader
import infer_with_data_loader
...
target_datasets = ["CTRPv2", "GDSCv1","GDSCv2", "CCLE", "gCSI"]
    ...
    for split in split_nums:
        ...
        for target_data_name in target_datasets:
            ...
            preprocess_run = ["python",
                  "preprocess_with_data_loader.py",
            ...
            if model_outdir.exists() is False:
                ...
                result = subprocess.run(train_run, stdout=subprocess.PIPE,
                                        text=True, check=True)
                print(result.stdout)
                print(result.stderr)
...
print_fn("Finished a cross-study run.")