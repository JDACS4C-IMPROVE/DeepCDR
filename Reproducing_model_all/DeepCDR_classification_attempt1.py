# -*- coding: utf-8 -*-
"""
Created on Wed Feb  1 21:19:09 2023
...
class MyCallback(Callback):
    ...
    def on_train_end(self, logs={}):
        ...
        self.model.save('/common/statsgeneral/gayara/DeepCDR/Checkpoint_classification_try1')
...
def ModelTraining(model,X_drug_data_train,X_mutation_data_train,X_gexpr_data_train,X_methylation_data_train,Y_train,validation_data,nb_epoch=100):
    ...
    callbacks = [ModelCheckpoint('/common/statsgeneral/gayara/DeepCDR/Checkpoint_classification_try1',monitor='val_average_precision',save_best_only=True, save_weights_only=False),
...
def main():
    ...
    ModelEvaluate(model,X_drug_data_test,X_mutation_data_test,X_gexpr_data_test,X_methylation_data_test,Y_test,cancer_type_test_list,'/common/statsgeneral/gayara/DeepCDR/Checkpoint_classification_try1')
